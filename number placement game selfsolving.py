from number_placement_solution import *
...
def number_placement_game():
    ...
    player_numbers = get_player_input(puzzle_nums, puzzle)
...
def get_player_input(puzzle_nums, puzzle):
    is_valid_input = False
    while not is_valid_input:
        print("Enter the puzzle numbers in the correct order, separated by spaces.")
        player_values = numberPlacementSolution(puzzle_nums, puzzle)
